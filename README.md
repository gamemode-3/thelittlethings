...
<table>
    ...
    <tr>
        <td><a href="#files.load_file">🗁</a></td>
    ...
    <tr>
        <td><a href="#variable.get_instances">ᎥᎥᎥ</a></td>
    ...
    <tr>
        <td><a href="#variables.get_names">佟</a></td>
